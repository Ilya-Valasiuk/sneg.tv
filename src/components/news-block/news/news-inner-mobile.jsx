  ...
  getContent() {
    ...
    return (
      <Fragment>
        ...
        {showIframe && (
          <div className="py-3 without-margins">
        ...
        <blockquote>
          Пресс-служба МВД Кабардино-Балкарии подтверждает факт нападения
          на&nbsp;экипаж ДПС в&nbsp;составе трех человек, один
          из&nbsp;сотрудников получил ножевое ранение. Работает
          оперативно-следственная группа,
          <cite>&nbsp;— заявили в&nbsp;ведомстве. </cite>
        </blockquote>
        <hr className="my-4" />
        <div className="news-inner-caption mb-4">
          <Row noGutters className="align-items-center">
            <Col xs="auto" className="text-uppercase news-inner-caption-header">
              автор
            </Col>
            <Col className="ml-3 news-inner-caption-text">
              <span className="styled">{authorName}</span>, {authorTitle}
            </Col>
          </Row>
        </div>
        <Row noGutters>
          <Button
            className="comments-btn w-100"
            outline
            onClick={onToggleCommentsPopup}
          >
            Обсудить (4)
          </Button>
        </Row>
  ...
  render() {
    ...
    return (
      <div className="news-inner">
        ...
        <div className="news-inner-img-signature size-14 mb-2 ">
          {imgSignature}
        </div>
